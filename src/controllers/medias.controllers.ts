...
export const serveVideoStreamController = async (req: Request, res: Response, next: NextFunction) => {
  // đọc video dung lượng bao nhiêu bytes trả về cho client từng đoạn dung lượng
  // vd dung lượng 100 bytes
  // - dựa vào khoảng thời gian đoạn đầu trả về 1 -> 10 bytes, tiếp 11 -> 20 bytes, ... trả về từng bytes
